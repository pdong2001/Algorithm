...
namespace Run
{
    public static class Practice_III
    {
        public static void TestSort(int n)
        {
            ...
            //Common.Monitoring(() =>
            //{
            //    temp.QuickSortRecursive(0, n - 1);
            //    Console.WriteLine("Quick sort: " + temp.IsSorted());
            //});
            ...
            Common.Monitoring(() =>
            {
                ...
                list.Sort();
                Console.WriteLine("C# Intro sort with sort helper: " + list.ToArray().IsSorted());
            });

            temp = arr.Clone() as int[];
            Common.Monitoring(() =>
            {
                temp = temp.MergeSort().ToArray();
                Console.WriteLine("Merge sort: " + temp.IsSorted());
            });
            //temp.Print(Max: 50);
            temp = arr.Clone() as int[];
            Common.Monitoring(() =>
            {
                temp.HeapSort();
                Console.WriteLine("Heap sort: " + temp.IsSorted());
            });
            //temp.Print(Max : 50);
            //list.Print(Max:50);
            //Common.Monitoring(() =>
